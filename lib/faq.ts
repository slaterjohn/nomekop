...
export const APP_INTRO: string =
  "Bindermon plans Pokemon TCG binder layouts in the browser. Pick any expansion, " +
...
export const FAQ_ENTRIES: FaqEntry[] = [
  {
    ...
    answer:
      ...
      "Bindermon has a dedicated master-set mode that lays out every variant for you.",
  },
  {
    ...
    answer:
      ...
      "directly beside the regular print, which is how Bindermon's master mode " +
      "arranges them.",
  },
  {
    ...
    answer:
      ...
      "Pokémon. Bindermon's master mode has a toggle for each run and can interleave " +
  ...
  },
  {
    ...
    answer:
      ...
      "commonly come in 4, 9, 12 and 16-pocket sizes, and Bindermon computes the " +
      "exact page count for any set, mode and pocket size before you buy.",
  },
  {
    question: "How do I print binder page layouts?",
    answer:
      "Bindermon renders your layout as A4 sheets with one binder page per sheet and " +
  ...
  },
  {
    ...
    answer:
      ...
      "Bindermon refreshes them at least every 12 hours. Treat them as a guide to " +
