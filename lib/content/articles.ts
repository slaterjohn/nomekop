...
export const ARTICLES: Article[] = [
  ...
  },
  {
    ...
    "description": "There are 107 cards named Charizard across 50 sets, starting with the famous Base Set #4 holo by Mitsuhiro Arita.",
    "date": "2026-06-12",
    "tags": [
      "Charizard",
      "counts",
  ...
  },
  {
    ...
    "description": "Fusion Strike (284 cards) is the largest single expansion; the SWSH Black Star Promos top the list at 304. The game spans 173 sets and 20,359 cards.",
    "date": "2026-06-12",
    "tags": [
      "sets",
      "counts",
