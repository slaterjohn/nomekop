...
export const en = {
  ...
  sets: {
    ...
    searchLabel: "Search sets by name",
    searchClear: "Clear search",
    noResults: "No sets match “{query}”.",
    resultCount: "{count} sets match “{query}”.",
    expandSection: "Expand {series}",
    collapseSection: "Collapse {series}",
    setCount: "{count} sets",
    viewInfo: "View set info",
    createLayout: "Create builder layout",
    modalClose: "Close",
    seriesLabel: "Series",
